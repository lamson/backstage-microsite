...
> Generally, a unit test should not test exactly how the output appears, it should test that the functionality has an expected _general_ response to an input change.
